...
def inception_network(input_shape=(224, 224, 3), classes=1000):
    """Inception Network"""
    ...
    output_layer = K.layers.Dense(classes, activation='softmax')(x)
    
    model = K.Model(inputs=input_layer, outputs=output_layer, name="InceptionNetwork")
